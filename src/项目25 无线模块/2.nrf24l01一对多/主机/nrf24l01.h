...
#define TX_DATA_WITDH 2 //发送数据宽度2个字节
#define RX_DATA_WITDH 2 //接收数据宽度2个字节
...
extern idata unsigned char  RxData_Buf0[RX_DATA_WITDH];			   //保存通道0接收到的数据
//extern idata uchar RxData_Buf1[RX_DATA_WITDH];			   //保存通道1接收到的数据
//extern idata uchar RxData_Buf2[RX_DATA_WITDH];			   //保存通道0接收到的数据
//extern idata uchar RxData_Buf3[RX_DATA_WITDH];			   //保存通道1接收到的数据
//extern idata uchar RxData_Buf4[RX_DATA_WITDH];			   //保存通道0接收到的数据
//extern idata uchar RxData_Buf5[RX_DATA_WITDH];			   //保存通道1接收到的数据
/*********************************************************/
#endif